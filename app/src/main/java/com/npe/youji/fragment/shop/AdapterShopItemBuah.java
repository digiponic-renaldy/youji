...
public class AdapterShopItemBuah extends RecyclerView.Adapter<AdapterShopItemBuah.ViewHolder>{
    ...
    public AdapterShopItemBuah(Context context, List<JoinModel> items, ShopFragment fragment) {
