...
public class PelangganModel {
    ...
    public PelangganModel(int id, String created_at, String updated_at, String deleted_at, String name, String email, String address, String phone, String phone_other) {
        this.id = id;
