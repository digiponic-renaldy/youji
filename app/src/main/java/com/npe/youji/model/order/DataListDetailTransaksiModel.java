...
public class DataListDetailTransaksiModel {
    @SerializedName("id")
    int id;
    ...
    public DataListDetailTransaksiModel() {
    }

    public DataListDetailTransaksiModel(int id, int id_penjualan, String kode_penjualan, int id_produk, String kode_produk, String nama_produk, String satuan, String satuan_keterangan, int kuantitas, int harga, int diskon, String diskon_tipe, int subtotal, int grand_total, String created_at, String updated_at, String deleted_at, String gambar) {
        this.id = id;
